...
<style>
    ...
    <div id="watingPixPaymentBox" style="display: <?php echo $paid ? 'none' : 'block'; ?>;">      <?php
        ...
        <input type="hidden" name="wc_iopay_pix_order_key" value="<?php echo esc_html( sanitize_text_field( $order->id ) ); ?>"/>
