...
<fieldset id="iopay-credit-cart-form">
    ...
    <p class="form-row">
        ...
        <input id="iopay-card-number"  data-keyup-credit-card autocomplete="off" class="input-text wc-credit-card-form-card-number" type="text" maxlength="20" autocomplete="off" placeholder="&bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull;" style="font-size: 1.5em; padding: 8px;" />
    </p>
    <div class="clear"></div>
    ...
    <p class="form-row form-row-last">
        ...
        <input id="iopay-card-cvc" class="input-text wc-credit-card-form-card-cvc" maxlength="4" type="text" autocomplete="off" placeholder="<?php esc_html_e('CVC', 'woocommerce-iopay'); ?>" style="font-size: 1.5em; padding: 8px;" />
    </p>
    <div class="clear"></div>
...
if (apply_filters('wc_iopay_allow_credit_card_installments', 1 < $max_installment)) :
    ...
    for ($installment = 1; $installment <= $installments['max_installments']; $installment++) {
      ...
      //  $interest = ( ( $cart_total * 100 ) < $installment['amount'] ) ? sprintf(__('(total of %s)', 'woocommerce-iopay'), strip_tags(wc_price($installment['amount'] / 100))) : __('(interest-free)', 'woocommerce-iopay');
        ...
        ?>
                    <option value="<?php echo absint($installment); ?>"><?php echo $installment; ?> - <?php echo wc_price($parcelado); ?></option>
                <?php } ?>
            </select>
        </p>
            <?php endif; ?>
