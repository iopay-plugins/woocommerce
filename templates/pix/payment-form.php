...
<fieldset id="iopay-credit-cart-form">
    ...
    <p class="form-row">
        ...
        <input id="iopay-card-number" class="input-text wc-credit-card-form-card-number" type="text" maxlength="20"
            autocomplete="off"
    ...
    <p class="form-row form-row-last">
        <label
            ...
            <span class="required">*</span></label>
        <input id="iopay-card-cvc" class="input-text wc-credit-card-form-card-cvc" type="text" autocomplete="off"
        ...
        <select name="iopay_installments" id="iopay-installments" style="font-size: 1.5em; padding: 8px; width: 100%;">
            ...
            <?php
                foreach ( $installments as $number => $installment ) :
                    ...
                    ?>
            <option
                value="<?php echo absint( $installment['installment'] ); ?>">
                <?php printf( esc_html__( '%1$dx of %2$s %3$s', 'woocommerce-iopay' ), absint( $installment['installment'] ), esc_html( $installment_amount ), esc_html( $interest ) ); ?>
            </option>
            <?php endforeach; ?>
        </select>
    </p>
